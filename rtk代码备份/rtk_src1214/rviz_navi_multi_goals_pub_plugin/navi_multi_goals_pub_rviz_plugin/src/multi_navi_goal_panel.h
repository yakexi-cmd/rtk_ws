...
namespace navi_multi_goals_pub_rviz_plugin {
    ...
    protected:
        ...
        QPushButton *output_maxNumGoal_button_, *output_delet_button_, *output_startNavi_button_, *output_cancel_button_;
        ...
        // The ROS node handle.
        ros::NodeHandle nh_;
        ros::Publisher goal_pub_, cancel_pub_, marker_pub_, multi_goal_pub_;
