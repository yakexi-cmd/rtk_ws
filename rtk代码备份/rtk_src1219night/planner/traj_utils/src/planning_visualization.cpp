...
namespace ego_planner
{
  PlanningVisualization::PlanningVisualization(ros::NodeHandle &nh)
  {
    ...
    planning_time_pub = nh.advertise<visualization_msgs::Marker>("/planning_time", 10);
  }
  ...
  {
    std::cout<<"=========displayMarkerList==========="<<std::endl;
  ...
  {
    std::cout<<"=========displayGlobalPathList==========="<<std::endl;
  ...
  void PlanningVisualization::displayPlanningTime(const double &planning_time, const Eigen::Vector3d &pos)
  {
    ...
    marker.text="Planning time : " + to_string(planning_time * 10) + "s";
    marker.pose=pose;
    planning_time_pub.publish(marker);

  }

  void PlanningVisualization::displayInfo(const string& str, const Eigen::Vector3d &pos)
  {
    visualization_msgs::Marker marker;
    marker.header.frame_id="map";
    marker.header.stamp = ros::Time::now();
