...
namespace ego_planner
{
    ...
    private:
        ...
        ros::Publisher replan_pub_, new_pub_, bspline_pub_, data_disp_pub_,cmd_pub_,adjust_cmd_pub_,odom_adjust_pub_,dir_pub,stop_pub, stop_bool_pub;
        /* helper functions */
        ...
        */
        bool planFromCurrentTraj();//如果状态是重规划，则利用当前的位置速度状态进行重规划
